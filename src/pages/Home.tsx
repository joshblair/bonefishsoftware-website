  ...
  return (
    <main className="flex-1">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-24 pb-28 text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl text-[#8B95A3] max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-20 bg-[#1C2028]/40">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-[#8B95A3] text-lg max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredServices.map((svc) => (
              ...
              >
                ...
                <p className="text-[#8B95A3] text-sm leading-relaxed">{svc.description}</p>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 border-y border-[#2A3040]">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <p className="text-center text-xs uppercase tracking-widest text-[#8B95A3] mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {certifications.map((cert) => (
              <span
                key={cert.short}
                title={cert.name}
                className="rounded-full border border-[#2A3040] bg-[#1C2028] px-3 py-1 text-xs font-medium text-[#8B95A3]"
              >
                {cert.short}
              </span>
            ))}
      ...
      <section className="py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-[#00D4FF]/20 bg-gradient-to-br from-[#1C2028] to-[#232936] p-10 text-center">
            <h2 className="text-3xl font-semibold text-[#F0F4F8] mb-4">
