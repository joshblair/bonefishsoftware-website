            ...
            {team.map((member) => (
              ...
              >
                      ...
                      <div className="mt-4 flex gap-5">
                        {member.linkedin && (
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 text-xs text-[#CBD5E1] hover:text-[#00D4FF] transition-colors"
                          >
                ...
                <div className="mt-8 pt-6 border-t border-[#2A3040]">
                  <p className="text-xs uppercase tracking-widest text-[#CBD5E1] mb-3">
                    Certifications
                  </p>
...
function Avatar({ photo, name }: { photo?: string; name: string }) {
  ...
  return (
    <div className="h-28 w-28 rounded-full bg-[#232936] border-2 border-[#00D4FF]/30 flex items-center justify-center text-4xl text-[#CBD5E1]">
      👤
    </div>
  );
}
