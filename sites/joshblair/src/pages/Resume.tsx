const experience = [
  ...
  },
  {
    ...
    company: 'HydraForce, Inc. — Lincolnshire, Illinois',
    bullets: [
      'Designed and developed custom software for internal employees and external partners, including an Intranet, Supplier Extranet, Customer Extranet, quoting system, eProcurement system, and ASN system.',
      'Built B2B integrations with customers and suppliers and custom solutions integrating to the Fourth Shift ERP system.',
      'Performed SQL Server database administration, maintenance, and support across custom and ERP databases.',
      'Led ERP conversion — migrating from a hierarchical database backend to SQL Server 2005.',
      'Administered application servers, web servers, and Subversion SCM.',
      'Served as Team Lead, providing training and guidance to peer developers via hands-on sessions, documentation, and screencasts.',
      'R&D into B2B integration, BPM, BizTalk, BPEL, and SOA technologies.',
    ],
  },
  {
    period: '1996 – 2005',
    ...
    bullets: [
      '(2002–2005) Designed and developed Lean Automation software for the manufacturing industry using C# .NET, WinForms, SQL Server 2000, and SSRS. Collaborated with US and Bangalore teams on design, requirements, and delivery.',
      '(1999–2002) Developed an e-commerce system using C#, ASP.NET, and .NET Web Services integrating with a legacy ERP system, credit card processors, and shipping companies.',
      '(1999–2002) Built Supplier Center and Employee Center web-based extranet systems using ASP and VB 6.0 integrated with the legacy ERP.',
      '(1996–1999) Developed early e-commerce system using ASP and VB 6.0; handled onsite project implementation, hardware, software, and network configuration.',
      'Designed and maintained SQL database structures including tables, stored procedures, and views throughout.',
    ],
  },
  {
    period: '1993 – 1995',
    role: 'CAD Technician, Programmer & Web Designer',
    company: 'Sub Surface Tools, LLC — New Iberia, Louisiana',
    bullets: [
      'Instituted the CAD department, improving quality and efficiency across engineering documentation.',
      'Measured and drew a library of 1,000+ detailed oilfield parts using AutoCAD.',
      'Developed AutoCAD LISP routines to automate the assembly of schematics from the parts library.',
      'Designed the corporate website; implemented TCP/IP network infrastructure.',
    ],
  },
]
